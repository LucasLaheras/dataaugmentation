...
# self.data, self.mapped, self.control_points, self.control_points_data, self.weights, self.dim = dim, self.labels, self.label, self.scale, self.data_center, self.control_points_center, self.U, self.S, self.V
#########
...
######### RuntimeWarning: divide by zero encountered in double_scalars 198
    def unscale(self):
